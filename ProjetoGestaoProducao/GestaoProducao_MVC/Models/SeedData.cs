    ...
    public class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
                    ...
                    DbContextOptions<GestaoProducao_MVCContext>>()))
            {
                ...
                Apontamento apt1 = new Apontamento(new DateTime(2022, 09, 14), new DateTime(2022, 09, 14), null, "Peça concluida", Enums.AptStatus.Ativo,Enums.Operacao.Desbaste, Pro1, maq1, Func1);
                Apontamento apt2 = new Apontamento(new DateTime(2022, 09, 14), new DateTime(2022, 09, 14), null, "Peça concluida", Enums.AptStatus.Ativo, Enums.Operacao.Pintura, Pro1, maq2, Func2);
                Apontamento apt3 = new Apontamento(new DateTime(2022, 09, 14), new DateTime(2022, 09, 14), null, "Peça concluida", Enums.AptStatus.Ativo, Enums.Operacao.Acabamento, Pro2, maq3, Func3);
